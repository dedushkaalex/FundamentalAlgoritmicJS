/*
Стек - структура данных, у которой есть одна точка входа и выхода. Каждый элемент который туда входит, выходит из этой же точки.
То есть Первый пришел - последний вышел
*/
// Stack structure:
